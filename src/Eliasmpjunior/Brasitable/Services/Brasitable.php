...
namespace Eliasmpjunior\Brasitable\Services;

use Web64\Colors\Facades\Colors;

use Eliasmpjunior\Brasitable\Exceptions\TableHeaderEmptyException;
use Eliasmpjunior\Brasitable\Exceptions\TableContentErrorException;
use Eliasmpjunior\Brasitable\Exceptions\TableHeaderColumnMissingTitleException;
use Eliasmpjunior\Brasitable\Exceptions\TableContentColumnCountOverflowException;
...
class Brasitable
{
	...
	{
		$currentTable = new Brasitable($tableHeader);
